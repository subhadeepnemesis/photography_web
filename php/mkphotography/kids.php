...
<body>
    ...
    <div class="alime-portfolio-area section-padding-80 clearfix">
        <div class="container-fluid">
            ...
            <?php
                $kids_dir = 'img/assets/kids/';
                $files = glob($kids_dir.'*.{jpg}', GLOB_BRACE);
                if (isset($files) && count($files) > 0){
                    foreach($files as $key=>$val){
                        // <!-- Single Gallery Item -->
                        $each_files = glob($kids_dir.($key+1).'/*.{jpg}', GLOB_BRACE);
                        ...
                        echo '<div class="col-12 col-sm-6 col-lg-3 single_gallery_item video human mb-30 wow fadeInUp" data-wow-delay="300ms">
                                <div class="single-portfolio-content">
                                    ...
                                    <div class="hover-content">
                                      ...
                                      <span style="display:none;">kids_'.($key+1).'_'.$each_counter.'</span>
                                    </div>
                                </div>
                            </div>';
                    }
